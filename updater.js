    ...
    function startUpdater() {
      ...
      if (Lampa.Platform.is("android")) {
        ...
        var checkUpdate = function checkUpdate() {
          ...
          network['native']("https://api.github.com/repos/Bylumpa/LAMPA-ATV/releases", function (found) {
            if (found) {
                ...
                if (autoCheck) {
                  ...
                  Lampa.Modal.open({
                    ...
                    onSelect: function onSelect() {
                      if (semverCompare(current_version, "1.11.9-553") < 0) {
        ...
        var current_version = typeof AndroidJS !== "undefined" ? AndroidJS.appVersion() : "1.11.8-521";
        var isLampaTV = current_version.startsWith("1.");
