(function() {
  ...
  if (!window.rch) {
    Lampa.Utils.putScript(["http://batmen.my.to/invc-rch.js"], function() {}, false, function() {
      if (!window.rch.startTypeInvoke)
        window.rch.typeInvoke('http://batmen.my.to', function() {});
    }, true);
  }
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('http://batmen.my.to/lite/withsearch'), function(json) {
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('http://batmen.my.to/player-inner/' + element.url);
      return;
    }
    ...
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1)
      Noty.show('ÐÐ½ÐµÑÐ½Ð¸Ð¹ Ð¿Ð»ÐµÐµÑ Ð¼Ð¾Ð¶Ð½Ð¾ ÑÐºÐ°Ð·Ð°ÑÑ Ð² init.conf (playerInner)', {time: 3000});
    Player.play(element);
  }
}
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      version: '',
      name: 'BATmen  ðºð¦',
      description: 'ÐÐ»Ð°Ð³ÑÐ½ Ð´Ð»Ñ Ð¿ÐµÑÐµÐ³Ð»ÑÐ´Ñ',
      component: 'bat',
    ...
    Lampa.Component.add('bat', component); //ÑÐ¾ Ð¶Ðµ ÑÐ°Ð¼Ð¾Ðµ
    resetTemplates();
